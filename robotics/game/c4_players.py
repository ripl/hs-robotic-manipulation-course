...
class Player:
    """
    Represents a player in a Connect_Four instance.
...
class Arm(Player):
    """
    Represents a Robotic arm in a Connect_Four instance.
    ...
    ArmPlayer 2 is "o"
    """
    def __init__(self, piece, config_path='../config.json', positions_path='../actions_c4.json'):
        """
...
class SmartArm(Arm):
    ...
    def novice(self, game):
        ...
        random_move = random.sample(possible_moves, k=1)[0]
    ...
    def pro(self, game):
        ...
        for move in possible_moves:
            ...
            can_win = game.current_player_wins()
...
#
    ...
    def pseudo_place_piece(self, game, pos, piece):
        ...
        for row in reversed(range(6)):
            if game.board[row][pos] is None:
                game.board[row][pos] = piece
                self.pseudo_pos = (row, pos)
                return
    ...
    def pseudo_undo(self, game, pos):
        ...
        """
        game.board[self.pseudo_pos[0]][self.pseudo_pos[1]] = None
        return
