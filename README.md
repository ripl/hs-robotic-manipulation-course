...
For the follower arm: Set the IDs from 1 to 6, with 1 being the motor closest to the base and 6 being the final motor for the claw. Set each motor's baudrate to 1 Mbps.
